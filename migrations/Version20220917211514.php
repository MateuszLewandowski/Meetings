 ...
 */
final class Version20220917211514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meeting (id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, participants_limit INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_F515E1397E3C61F9 ON meeting (owner_id)');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, name VARCHAR(128) DEFAULT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE meeting ADD CONSTRAINT FK_F515E1397E3C61F9 FOREIGN KEY (owner_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE meeting DROP CONSTRAINT FK_F515E1397E3C61F9');
